...
//   setTimeout(() => messageSucessfullySent ? onSucess(currentTemperature) : onFailure('Robot is busy'), messageDelay());
// };
...
// getPokemonDetails((pokemon) => pokemon.name === 'Bulbasaur', (error, message) => error ? console.log(error) : console.log(message));
...
// 9 - A fim de evitar que futuros treinadores sejam prejudicados, o Professor Carvalho pediu que você o ajude a escrever testes para o sistema que distribui os pokémons.
...
//       expectedError(error).toEqual(expectedError);
//       done();
//     }
